...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='sku',
                             help='coco | kitti | coco_hp | pascal | sku')
    ...
    self.parser.add_argument('--ag_weight', type=float, default=0.5,
                             help='loss weight for bounding angle size.')
    # multi_pose
